...
class HierarchicalSummarizer:
    def __init__(
        self, summarizer: SimpleSummarizer, embedding_generator: EmbeddingGenerator
    ):
        self.summarizer = summarizer
    ...
    def create_hierarchical_summaries(
        ...
        while len(current_summaries) > 1:
            ...
            for cluster_idx, cluster in enumerate(clusters):
                ...
                new_embedding = self.embedding_generator.generate_embeddings_from_text(
                    new_summary_content
                )
        ...
        if current_summaries:
            ...
            root_embedding = self.embedding_generator.generate_embeddings_from_text(
                final_summary
            )
            ...
            root_summary = {
                ...
                "embedding": (
                    root_embedding.tolist()
                    if hasattr(root_embedding, "tolist")
                    else root_embedding
                ),
            }
